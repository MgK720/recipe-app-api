...
class ModelTests(TestCase):
    ...
    def test_recipe_file_name_uuid(self, mock_uuid):
        ...
        uuid = 'test-uuid' # here we use patch decorator (normalnie wygenerowałby się uuid ktorego nie zgadniemy - wiec nadpisujemy domyslne dzialanie uuid decoratorem i ustalamy samemu) # noqa
